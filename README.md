...
|--|--|--|---|---|
| [VA1 (Wearable Device 2026)](https://github.com/ariankharazmi/VA1-Wearable-Device-2026) | Wearable Device 2026 serves as tool for improving workplace and occupational outcomes. Automate a task via voice, capture your POV, or get mobile notifications without taking out your phone or PC, and much more. | Single-Board-Computer, Microcontrollers, Linux, Debian, Python, CustomTkinter, Microsoft Azure integration, GPIO, I2C, Sony ECX336C micro-display, Radxa Zero 2 Pro | VA1 Prototype has been completed for UC Senior Capstone Project I Presentation; now prepping for Microsoft Imagine Cup 2026. | Winter 2024 - Present |
